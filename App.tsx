      ...
      <div className="flex h-screen bg-slate-50 overflow-hidden">
        ...
        >
          ...
          <nav className="flex-1 p-4 overflow-y-auto">
            ...
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4 mt-6 px-4">Operacional</div>
            ...
            <SidebarLink to="/faturamento" icon={Receipt} label="MRR" />
            
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4 mt-6 px-4">Documentos Fiscais</div>
            <SidebarLink to="/nfse" icon={FileText} label="Emissão NFS-e" />
            <SidebarLink to="/nfe" icon={Files} label="Emissão NF-e" />

            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4 mt-6 px-4">Comunicação</div>
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden">
          <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 z-10">
            ...
            <div className="flex items-center gap-4 ml-auto">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[10px] text-slate-500 font-black uppercase">BPO Expert</p>
              </div>
              <img src="https://picsum.photos/40/40" alt="Profile" className="w-10 h-10 rounded-full border-2 border-slate-100" />
            </div>
          </header>
          ...
          <main className="flex-1 overflow-auto p-4 lg:p-8">
            <Routes>
              ...
              <Route path="/estoque" element={<InventoryScreen />} />
